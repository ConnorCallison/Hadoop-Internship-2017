-- Create STG_HCM_PRE_COMP Table in Hive
...
SELECT distinct * FROM STG_HCM_PRE_COMP c
WHERE c.DW_COMP_LN_CNT > 1;

DELETE FROM STG_HCM_PRE_COMP WHERE DW_COMP_LN_CNT > 1;
