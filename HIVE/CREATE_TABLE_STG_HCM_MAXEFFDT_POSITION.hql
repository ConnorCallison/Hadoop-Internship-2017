-- Create STG_HCM_MAXEFFDT_POSITION Table in Hive
-- Author: Connor Callison (ccallison@humboldt.edu)
-- Date Last Modified: 12/16/2017

set hive.execution.engine=tez;

DROP TABLE STG_HCM_MAXEFFDT_POSITION;

CREATE TABLE STG_HCM_MAXEFFDT_POSITION (
`POSITION_NBR`	        STRING,
`EFFDT`	                TIMESTAMP,
`EFF_STATUS`	        STRING,
`DESCR`	                STRING,
...
INSERT INTO STG_HCM_MAXEFFDT_POSITION
(
  `position_nbr`	   
, `effdt`	      
, `eff_status`	
